<svelte:head>
    <title>Imanuel Ulbricht – Ferchau</title>
</svelte:head>
<main class="iuc-employer">
    <header class="iuc-employer__header">
        ...
        <h1 class="iuc-employer__name">FERCHAU GmbH</h1>
    </header>
    <img alt="Ferchau Logo" aria-hidden="true" class="iuc-employer__logo" src="/assets/employers/FERCHAU.png" />
    <h2 class="iuc-employer__heading-two">Who is FERCHAU?</h2>
    <blockquote class="iuc-employer__quote">
        ...
        <p class="iuc-employer__text">
            Der Engineering- und IT-Dienstleister bietet seinen Kunden drei Leistungsbausteine an: Im Bereich
            Engineering Competence übernimmt das Unternehmen ganze Workpackages, die entweder beim Kunden vor Ort oder
            in den eigenen Technischen Büros bearbeitet werden. Im zweiten Kompetenzfeld, dem Engineering Support,
            unterstützen die Fachkräfte des Engineering- und IT-Dienstleisters den Kunden vor Ort. Im dritten Bereich,
            den Managed Services, unterstützt FERCHAU seine Kunden bei der Bündelung von Beschaffungsprozessen für
            Engineering- und IT-Dienstleistungen.
        </p>
        <cite class="iuc-employer__cite">
            <a class="iuc-employer__cite--link" href="https://www.ferchau.com/de/de" target="_blank">
                FERCHAU GmbH
            </a>
        </cite>
    </blockquote>
    <h2 class="iuc-employer__heading-two">Who are FERCHAUs’ clients?</h2>
    <ul class="iuc-employer__list">
        <li>None published</li>
    </ul>
    <h2 class="iuc-employer__heading-two">What did I do at FERCHAU?</h2>
    <p class="iuc-employer__text">
