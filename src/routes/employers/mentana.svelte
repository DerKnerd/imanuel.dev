<main class="iuc-employer">
    ...
    <blockquote class="iuc-employer__quote">
        <p class="iuc-employer__text">
            Die Mentana-Claimsoft GmbH ist seit mehr als 20 Jahren auf den Bereich elektronischer Signaturen
            spezialisiert und unterstützt Ihre Kunden mit sicheren Signaturlösungen bei einem effizienten
            Digitalisierungsprozess. Das Ziel: reibungslose Arbeitsabläufe, eine gesteigerte Wirtschaftlichkeit und ein
            hohes Maß an Rechtssicherheit. Dabei entwickeln wir individuelle Kundenlösungen und binden unsere
            Technologien in etablierte Prozesse, Fachanwendungen und Archive ein.
        </p>
        <p class="iuc-employer__text">
