...
<main class="iuc-employer">
    ...
    <blockquote class="iuc-employer__quote">
        <p class="iuc-employer__text">
            Arvato is an internationally active services company and one of eight divisions of Bertelsmann SE & Co.
            KGaA.
        ...
        <p class="iuc-employer__text">
            ...
            providers to banks and insurance companies, e-commerce, IT and Internet providers – rely on Arvato’s
            portfolio
            of solutions.
        </p>
        <cite class="iuc-employer__cite">
            <a class="iuc-employer__cite--link" href="https://www.bertelsmann.com/divisions/arvato/" target="_blank">
                Bertelsmann SE & Co. KGaA
            </a>
        </cite>
    </blockquote>
    <h2 class="iuc-employer__heading-two">Who are Arvatos’ clients?</h2>
    <ul class="iuc-employer__list">
        <li>Esprit</li>
        <li>Tommy Hilfiger</li>
        <li>Versace</li>
    </ul>
    <h2 class="iuc-employer__heading-two">What did I do at Arvato?</h2>
    <p class="iuc-employer__text">
