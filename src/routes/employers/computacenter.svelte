<main class="iuc-employer">
    ...
    <img alt="Computacenter AG & Co. oHG" class="iuc-employer__logo" src="/assets/employers/computacenter.png" />
    ...
    <blockquote class="iuc-employer__quote">
        ...
        <p class="iuc-employer__text">
            Computacenter provides user support, supply chain management, and secure provision of applications and data
            to
        ...
        <cite class="iuc-employer__cite">
            <a class="iuc-employer__cite--link" href="https://www.computacenter.com/uk/about-us/company-profile"
               target="_blank">
                Computacenter Ltd.
            </a>
        </cite>
