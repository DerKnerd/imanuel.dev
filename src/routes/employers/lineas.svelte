<svelte:head>
    <title>Imanuel Ulbricht – About my time at Ferchau</title>
</svelte:head>
<main class="iuc-employer">
    <header class="iuc-employer__header">
        ...
        <h1 class="iuc-employer__name">LINEAS Informationstechnik GmbH</h1>
    </header>
    <img alt="LINEAS Informationstechnik GmbH Logo" aria-hidden="true" class="iuc-employer__logo"
         src="/assets/employers/lineas.png" />
    <h2 class="iuc-employer__heading-two">Who is LINEAS?</h2>
    <blockquote class="iuc-employer__quote">
        <p class="iuc-employer__text">
            ...
            Erfolg unserer Kunden bei und entwickeln für Sie maßgeschneiderte, zukunftssichere, integrierte Lösungen.
        </p>
        <p class="iuc-employer__text">
            Mit unserem marktorientierten Themenmanagement erweitern wir unser Leistungsportfolio und die Kompetenz
            unserer Mitarbeiter um neue Technologien und Methoden. Auf dieser Basis entwickeln sich unsere Mitarbeiter
            kontinuierlich weiter.
        </p>
        <p class="iuc-employer__text">
            Wir bieten Service in vollem Umfang: Unser Team aus hochspezialisierten Profis begleitet jeden Kunden von
            der Beratung über die Konzeption und Entwicklung bis hin zum Rollout und übernimmt auch den anschließenden
            Support. Dabei folgen sie stets unseren Grundwerten:
        </p>
        <ul>
        ...
        <cite class="iuc-employer__cite">
            <a class="iuc-employer__cite--link" href="https://www.lineas.de/unternehmen/" target="_blank">
                LINEAS Informationstechnik GmbH
            </a>
        </cite>
    </blockquote>
    <h2 class="iuc-employer__heading-two">Who are LINEAS’ clients?</h2>
    <ul class="iuc-employer__list">
        <li>None published</li>
    </ul>
    <h2 class="iuc-employer__heading-two">What did I do at LINEAS?</h2>
    <p class="iuc-employer__text">
