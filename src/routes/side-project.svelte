<div class="iuc-side-project">
    ...
    <section class="iuc-side-project__section">
        <img alt="" aria-hidden="true"
             class="iuc-side-project__image iuc-side-project__image--right" src="/assets/jinya/jinya-web-startpage.png" />
    ...
    <section class="iuc-side-project__section">
        <img alt="" aria-hidden="true"
             class="iuc-side-project__image iuc-side-project__image--left" src="/assets/jinya/jinya-app-startpage.png" />
        <p class="iuc-side-project__paragraph">
