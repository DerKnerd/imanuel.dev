    ...
    <main class="iuc-about__content">
        <section class="iuc-about__section">
            ...
            <p class="iuc-about__paragraph">
                ...
                Hildesheim in 2010, I started programming in 2007 at the age of 13. The first programming language I
                worked
                with was Delphi 5 and it was there that I discovered my passion for programming. To extend my knowledge
                in
            ...
            <p class="iuc-about__paragraph">
                Due to my interest in programming I started an apprenticeship as a computer science expert (subject
                area)
                software development at Mentana-Claimsoft GmbH in Bad Salzdetfurth at the end of 2010, which I
                successfully
                completed in June 2013. During my apprenticeship, I expanded and deepened my knowledge in the
                programming
                languages C++, C# and Java. Furthermore, I acquired basic knowledge in the languages SQL, JavaScript,
                CSS
                and HTML, which, among other things, formed an essential part of my final project work. Another
                essential
                part of my education was the field of cryptography as well as De-Mail.
            </p>
            <p class="iuc-about__paragraph">
                After my education I started a job at Netrada Europe GmbH. In February 2014 Netrada Europe GmbH was
                bought
                by arvato AG. During my time at arvato I got to know the world of backend eCommerce programming.
                Furthermore
                I gained knowledge of Borland C++ Builder 6 and the maintenance of legacy software.
            </p>
            <p class="iuc-about__paragraph">
                After my contract at arvato expired at the end of 2014, I took a job at Computacenter AG & co. oHG,
                where I
            ...
            <p class="iuc-about__paragraph">
                ...
                in-house shop system and got to know the advantages of working according to Scrum. In the course of
                time, I
                was employed for the development of webshops based on Shopware. There I found my way well and was able
                to
            ...
            <p class="iuc-about__paragraph">
                Later in the end of 2017 I accepted a new challenge at the company FERCHAU GmbH. There I was assigned to
                a
                customer in the automotive and financial area. There I improved my knowledge of modern web technologies
                like
            ...
            <p class="iuc-about__paragraph">
                At LINEAS I developed an internal project based on ReactJS and Express.js. In this project, I could
                train
                and improve my design skills. Currently I work at LINEAS. Due to confidentiality I cannot say much about
                the
