<div aria-label="My Skills" class="iuc-grid" role="grid">
    ...
    <div aria-hidden="true" class="iuc-grid__tile iuc-grid__tile--empty"></div>
    <a aria-label="My HTML5 skills" class="iuc-grid__tile" href="/skill/html5" role="gridcell" title="My HTML5 skills">
    ...
    <div aria-hidden="true" class="iuc-grid__tile iuc-grid__tile--empty"></div>
    <a aria-label="My Linux skills" class="iuc-grid__tile" href="/skill/linux" role="gridcell" title="My Linux skills">
        <img alt="Linux" aria-hidden="true" src="/assets/tools/linux.svg" />
    </a>
    <div aria-hidden="true" class="iuc-grid__tile iuc-grid__tile--empty"></div>
    <a aria-label="My Java skills" class="iuc-grid__tile" href="/skill/java" role="gridcell" title="My Java skills">
