...
<div aria-label="My Skills" class="iuc-grid" role="grid">
	...
	<a
		aria-label="My PHP skills"
		class="iuc-grid__tile"
		href="/skill/php"
		role="gridcell"
		title="My PHP skills"
	>
	...
	<div aria-hidden="true" class="iuc-grid__tile iuc-grid__tile--empty"></div>
	<a
		aria-label="My NodeJS skills"
		class="iuc-grid__tile"
		href="/skill/node"
		role="gridcell"
		title="My NodeJS skills"
	>
		<img alt="NodeJS" aria-hidden="true" src="/assets/tools/nodejs.svg" />
	</a>
	<div aria-hidden="true" class="iuc-grid__tile iuc-grid__tile--empty"></div>
	<a
		aria-label="My Google skills"
		class="iuc-grid__tile"
		href="/skill/google"
		role="gridcell"
	...
	<div aria-hidden="true" class="iuc-grid__tile iuc-grid__tile--empty"></div>
	<a
		aria-label="My Jetbrains skills"
		class="iuc-grid__tile"
		href="/skill/jetbrains"
		role="gridcell"
	...
	>
		<img
			...
			aria-hidden="true"
			src="/assets/tools/ApacheSoftwareFoundation.svg"
		/>
	</a>
	<div aria-hidden="true" class="iuc-grid__tile iuc-grid__tile--empty"></div>
	<a
		aria-label="My HTML5 skills"
		class="iuc-grid__tile"
		href="/skill/html5"
		role="gridcell"
		title="My HTML5 skills"
	>
		<img alt="HTML5" aria-hidden="true" src="/assets/tools/html.svg" />
	</a>
	<div aria-hidden="true" class="iuc-grid__tile iuc-grid__tile--empty"></div>
	<a
		aria-label="My Microsoft skills"
		class="iuc-grid__tile"
		href="/skill/microsoft"
		role="gridcell"
	...
	<div aria-hidden="true" class="iuc-grid__tile iuc-grid__tile--empty"></div>
	<a
		aria-label="My Atlassian skills"
		class="iuc-grid__tile"
		href="/skill/atlassian"
		role="gridcell"
	...
	<div aria-hidden="true" class="iuc-grid__tile iuc-grid__tile--empty"></div>
	<a
		aria-label="My Linux skills"
		class="iuc-grid__tile"
		href="/skill/linux"
		role="gridcell"
		title="My Linux skills"
	>
		<img alt="Linux" aria-hidden="true" src="/assets/tools/linux.svg" />
	</a>
	<div aria-hidden="true" class="iuc-grid__tile iuc-grid__tile--empty"></div>
	<a
		aria-label="My Java skills"
		class="iuc-grid__tile"
		href="/skill/java"
		role="gridcell"
		title="My Java skills"
	>
		<img alt="Java" aria-hidden="true" src="/assets/tools/java.svg" />
	</a>
	<div aria-hidden="true" class="iuc-grid__tile iuc-grid__tile--empty"></div>
	<a
		aria-label="My Database skills"
		class="iuc-grid__tile"
		href="/skill/database"
		role="gridcell"
