	...
	<nav aria-label="Main Menu" class="iuc-menu__left">
		...
		<button
			class={'iuc-menu__hamburger-button' +
				(menuToggled ? ' iuc-menu__hamburger-button--open' : '')}
			on:click={toggleMenu}
		>
		...
		<a
			...
			href="/side-project">My Side Project</a
		>
		<a
			class="iuc-menu__item"
			class:iuc-menu__item--active={activeRoute === '/employers'}
			href="/employers">My Employers</a
		>
	...
	<div class="iuc-hamburger-menu__top">
		<nav class="iuc-hamburger-menu__links">
			...
			<a
				...
				class:iuc-menu__item--active={activeRoute === '/side-project'}
				href="/side-project"
				on:click={toggleMenu}>My Side Project</a
			>
			<a
				class="iuc-hamburger-menu__item"
				class:iuc-menu__item--active={activeRoute === '/employers'}
...
<noscript
	><p><img alt="" src="//matomo.imanuel.dev/matomo.php?idsite=5&amp;rec=1" style="border:0;" /></p>
</noscript>
